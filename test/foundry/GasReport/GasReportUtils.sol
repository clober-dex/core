...
library GasReportUtils {
    ...
    function baseToRaw(OrderBook market, uint256 baseAmount, uint16 priceIndex, bool roundingUp)
        internal
        view
        returns (uint64)
    {
    ...
    function rawToBase(OrderBook market, uint64 rawAmount, uint16 priceIndex, bool roundingUp)
        internal
        view
        returns (uint256)
    {
    ...
    function encodeId(bool isBid, uint16 priceIndex, uint256 orderIndex) internal pure returns (uint256 id) {
        assembly {
